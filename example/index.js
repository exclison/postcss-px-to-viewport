...
const options = {
    ...
    landscape: true, //(Boolean) 是否添加根据 landscapeWidth 生成的媒体查询条件 @media (orientation: landscape)
...
const processedCss = postcss(postcssPxToViewport(options)).process(css,{from:url}).css
